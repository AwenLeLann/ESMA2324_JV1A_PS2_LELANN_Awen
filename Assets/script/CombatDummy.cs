...
public class CombatDummy : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject HitParticule;
    ...
    private void Start()
    {
        ...
        pc = GameObject.Find("Player").GetComponent<PlayerMouvement>();
    ...
    private void Damage(AttackDetails details)
    {
        ...
        Instantiate(HitParticule, aliveGO.transform.position, Quaternion.Euler(0.0f, 0.0f, Random.Range(0.0f, 360.0f)));
